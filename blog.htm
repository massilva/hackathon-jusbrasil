		...
		<div class="container-fill">
                ...
                <div class="container">
                    <div class="row">
                        <article class="span12">
                            ...
                            <h3><a href="blog_post_slider.htm">Slider Post</a></h3>
                            <h6><time datetime="2013-01-01" class="time">august 28,2012</time></h6>
                            </div>
                        </article>
                    </div>
			...
			<div class="row_1">
                <div class="container">
                    <div class="row">
                        <article class="span12">
                        	<div class="blog_post link_post">
                                <h3><a href="blog_post.htm">Tap or Click this link!</a></h3>
                                <h6><time datetime="2013-01-01" class="time">august 28,2012</time></h6>
                            </div>
                        </article>
                    </div>
			...
			<div class="row_1">
                <div class="container">
                    <div class="row">
                        <article class="span12">
                        	<div class="blog_post testim_post">
                                <h3><a href="blog_post.htm">"Probably someone saw all of 12 balloons<br>we set free from the balcony."</a></h3>
                                <h6><time datetime="2013-01-01" class="time">august 28,2012</time></h6>
                            </div>
                        </article>
                    </div>
			...
			<div class="row_1">
                <div class="container">
                    <div class="row">
                        <article class="span12">
                        	<div class="blog_post">
                                <div class="heding_post">
                                    <h3><a href="blog_post.htm">What if I will move heading?</a></h3>
                                    <h6><time datetime="2013-01-01" class="time">august 28,2012</time></h6>
                                </div>
                                <figure>
			...
			<div class="row_1">
                <div class="container">
                    <div class="row">
                        <article class="span12">
                        	<div class="blog_post">
                                <h3><a href="blog_post.htm">Yes, you can!</a></h3>
                                <h6><time datetime="2013-01-01" class="time">august 28,2012</time></h6>
                                <figure>
                                	<img src="images/img-8.jpg" alt="">
                                </figure>
			...
			<div class="row_1">
                <div class="container">
                    <div class="row">
                        <article class="span12">
                        	<div class="blog_post blog_post_nobg">
                                <h3><a href="blog_post.htm">Need to say something?</a></h3>
                                <h6><time datetime="2013-01-01" class="time">august 28,2012</time></h6>
                                ...
                                <a href="blog_post.htm" class="btn btn_1">read more</a>
                            </div>
                        </article>
                    </div>
                </div>
			...
			<div class="row_1">
                <div class="container">
                    <div class="row">
                        <article class="span12">
                        	<div class="blog_post default_post">
                                <h3><a href="blog_post.htm">Want to use default post type?</a></h3>
                                <h6><time datetime="2013-01-01" class="time">august 28,2012</time></h6>
                            ...
                            <div class="text-center indent3">
                            	<a href="#" class="btn btn_1">older posts</a>
                            </div>
                        </article>
                    </div>
                </div>
